...
-- Copiando dados para a tabela ecommerce_db.avaliacoes: ~8 rows (aproximadamente)
...
-- Copiando dados para a tabela ecommerce_db.carrinhos: ~1 rows (aproximadamente)
REPLACE INTO `carrinhos` (`id`, `usuario_id`, `data_criacao`) VALUES
	(1, 1, '2025-08-14 22:41:55'),
	(2, 2, '2025-08-14 23:09:36');
...
CREATE TABLE IF NOT EXISTS `carrinho_itens` (
  ...
  CONSTRAINT `carrinho_itens_ibfk_1` FOREIGN KEY (`carrinho_id`) REFERENCES `carrinhos` (`id`),
  CONSTRAINT `carrinho_itens_ibfk_2` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela ecommerce_db.carrinho_itens: ~1 rows (aproximadamente)
REPLACE INTO `carrinho_itens` (`id`, `carrinho_id`, `produto_id`, `quantidade`, `data_adicao`) VALUES
	(4, 1, 11, 1, '2025-08-14 22:58:01'),
	(5, 2, 11, 1, '2025-08-14 23:09:58');
...
-- Copiando estrutura para tabela ecommerce_db.imagens_produto
CREATE TABLE IF NOT EXISTS `imagens_produto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `produto_id` int(11) NOT NULL,
  `url` varchar(500) NOT NULL,
  `ordem` int(11) NOT NULL DEFAULT 1,
  `tipo` enum('capa','extra') DEFAULT 'extra',
...
-- Copiando dados para a tabela ecommerce_db.imagens_produto: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela ecommerce_db.pedidos: ~4 rows (aproximadamente)
REPLACE INTO `pedidos` (`id`, `usuario_id`, `total`, `status`, `endereco_entrega`, `data_pedido`, `data_atualizacao`) VALUES
	...
	(8, 1, 3799.98, 'pendente', 'rua exemplo, 123', '2025-08-14 22:57:51', '2025-08-14 22:57:51');
